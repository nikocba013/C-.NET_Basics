intellisense.annotate(jQuery, {
  ...
  'CeldaModel': function() {
    /// <summary>Deprecated in jQuery 1.3 (see jQuery.support). States if the current page, in the user's browser, is being rendered using the W3C CSS Celda Model.</summary>
...
intellisense.annotate(jQuery.fn, {
  ...
  'checkCelda': function() {
    /// <summary>Selects all elements of type checkCelda.</summary>
  },
  'checked': function() {
